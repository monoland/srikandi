...
class VuePageCommand extends GeneratorCommand
{
    ...
    protected function getStub()
    {
        ...
        if ($this->option('parent') && $this->option('child') === null) {
            $stub = '/stubs/vuepage.nested.stub';
        } elseif ($this->option('child') && $this->option('parent') === null) {
            $stub = '/stubs/vuepage.child.stub';
        } elseif ($this->option('parent') && $this->option('child')) {
            $stub = '/stubs/vuepage.both.stub';
        } else {
